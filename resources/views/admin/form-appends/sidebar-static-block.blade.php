<div class="form-group">
    ...
    <div class="dinamyc-blocks-add">
        <div class="row">
            <div class="col-md-5">
                <input name="sidebar[{{ $index }}][attribute_id]" id="" class="attribute form-control" placeholder="Введите название атрибута">
            </div>
            <div class="col-md-5">
                <input name="sidebar[{{ $index }}][attribute_item_id]" id="" class="attribute-item form-control" placeholder="Введите значение атрибута">
            </div>
            {{-- <div class="col-md-2">
