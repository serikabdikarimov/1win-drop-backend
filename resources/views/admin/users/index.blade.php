            ...
            @foreach($users as $item)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ url('/admin/users/' . $item->id . '/edit') }}" title="Редактирование пользователя"><button class="btn btn-primary btn-sm"><i class="far fa-edit"></i> Редактировать</button></a>
